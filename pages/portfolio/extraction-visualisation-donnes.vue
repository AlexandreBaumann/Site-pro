    ...
    data() {
        return {
            mesSlides: [
                ...
                {
                    title: 'GSC-Extractor', content: `<h3>weekExtractor.py</h3>
            
            <p>Le premier fichier, weekExtractor.py sert à extraire les données Google Search Console. Il faut renseigner la localisation de vos
           ...
           ` },
             ...
             ` },
                ...
                {
                    title: 'GSC-Extractor', content: ` <h3>categorize.py</h3>
            ...
            <p>Son fonctionnement est d'extraire les deux CSV dans des objets "DataFrame" (de la bibliothèque Pandas), de
                ...
                ` },
                {
                    title: 'Partie 2', content: `<h2>GSC-Dataviz: visualisation de données avec filtres en React</h2>
           ` },
                {
                    title: 'GSC-Dataviz', content: ` <p>Cette application est beaucoup plus complexe. Il va s'agir de charger les données dans un store Redux pour
            ...
            <p>Je reste un peu vague, nous verrons le fonctionnement exact en étudiant comment ces éléments sont
                utilisés.
            </p>` },
                {
            ...
            <p>L'action <strong>setPageFilter</strong>, importée du module <strong>filterSlice</strong>, est utilisée
                pour
                mettre à jour la
                ...
                exemple, si je sélectionne ma page "monsupersite.fr/electrolyse", je n'aurai que les requêtes et
                catégories
                ...
                filteredDataSlice. Cette action récupère le payload, ici l'état global, et lui applique les filtres.
                Enfin,
            ...
            <ul>
                <li>chartData, qui va définir les données s'affichant dans le tableau et est passé en props à l'élément
                    Line
                    (= le graphique).</li>
                <li>tableDataType correspond au type d'affichage du tableau: par pages ou par requêtes. (ex: si on
                    affiche
...
<p>Lorsque filteredData, startWeek ou endWeek change, un useEffect se déclenche pour mettre en forme les
    ...
    données par semaine. Puis, par la fonction formatData, importée de CharDataFormatter.js, qui va traduire
    ces
    données préparées en un langage compréhensible pour le graphique. Enfin, elles sont stockées dans un
    state
...
<p>Pour implémenter la fonctionnalité de tri, j'ai utilisé un autre 'useEffect' qui écoute les changements
    ...
    pour
    le tri.</p>
<p>Dans ce 'useEffect', une copie des données à afficher ('dataToDisplay') est triée en fonction de la clé
    et de
    la direction spécifiées dans 'sortConfig'. La clé peut être, par exemple, "Clicks" ou "Impressions", et
    la
...
<p>Cette approche rend le tableau dynamique et interactif, permettant aux utilisateurs de mieux comprendre
    ...
    données en les triant selon différentes métriques.</p>` },
                {
                    title: 'Améliorations futures', content: ` <h2>Améliorations futures</h2>
